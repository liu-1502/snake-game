...
export default function App() {
  ...
  return (
    <div
      ...
      } size-full min-h-screen flex flex-col items-center justify-start sm:justify-center p-2 min-[375px]:p-4 sm:p-8 pt-6 min-[375px]:pt-6 sm:pt-8 pb-0 min-[375px]:pb-0 sm:pb-8 bg-background text-foreground`}
    >
      ...
      <div className="page-column flex flex-col items-center gap-4 sm:gap-12 w-full pt-0 sm:pt-8 pb-2 min-[375px]:pb-4 sm:pb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-[1fr_auto_1fr] items-center gap-y-3 gap-x-2 w-full">
          ...
          <div className="col-start-2 row-start-1 sm:col-start-3 justify-self-end flex gap-2 min-[375px]:gap-2.5 above-crt">
            ...
            <PixelButton
              ...
              color={isMuted ? "ink-red" : "ink-green"}
              onClick={() => {
                const next = !isMuted;
                sfx.setMuted(next);
                setIsMuted(next);
